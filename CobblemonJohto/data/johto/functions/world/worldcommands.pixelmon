...
execute at @p[x=-252,y=63,z=-196,distance=0..30,tag=Dialogue5] run effect give @e[x=-252,y=63,z=-196,dy=3,nbt=!{cobblemon:npc_chatting}] minecraft:invisibility 10 10 true
...
execute as @a[x=-300,y=64,z=-509,distance=0..10,tag=Dialogue6,tag=!Dialogue7,scores={StarterPick=1}] run tp @e[x=-760,y=84,z=-242,dy=10,nbt=!{cobblemon:npc_trainer},scores={StarterPick=1}] -300 64 -509
execute as @a[x=-300,y=64,z=-509,distance=0..10,tag=Dialogue6,tag=!Dialogue7,scores={StarterPick=2}] run tp @e[x=-760,y=84,z=-242,dy=10,nbt=!{cobblemon:npc_trainer},scores={StarterPick=2}] -300 64 -509
execute as @a[x=-300,y=64,z=-509,distance=0..10,tag=Dialogue6,tag=!Dialogue7,scores={StarterPick=3}] run tp @e[x=-760,y=84,z=-242,dy=10,nbt=!{cobblemon:npc_trainer},scores={StarterPick=3}] -300 64 -509
...
execute as @a[x=-665,y=64,z=-493,distance=0..100,tag=Dialogue6] run tp @e[x=-665,y=63,z=-493,dy=2,nbt=!{cobblemon:npc_chatting}] -758 93 -242
execute as @a[x=-665,y=64,z=-493,distance=0..25,tag=!Dialogue6] run tp @e[x=-758,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] -665 64 -493
...
#tps out villagers
execute at @p[x=371,y=64,z=-698,distance=0..25,tag=!Dialogue16,scores={TalkTime=0}] run tp @e[x=371,y=63,z=-698,dy=3,nbt=!{cobblemon:npc_chatting}] 371 64 -698
...
#tps Kurt in
execute at @a[x=244,y=56,z=-714,distance=0..20,tag=!Dialogue15] run tp @e[x=-728,y=90,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] 244 39 -708

#Exterior Guard in
execute at @p[x=244,y=56,z=-714,distance=0..25,tag=!Dialogue14] run tp @e[x=-750,y=90,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] 247 54 -714

#Exterior Guard out
execute at @p[x=244,y=56,z=-714,distance=0..25,tag=Dialogue14] run tp @e[x=247,y=53,z=-714,dy=3,nbt=!{cobblemon:npc_chatting}] -750 91 -242
...
#Respawn Proton
execute at @a[x=289,y=38,z=-665,distance=0..10,tag=Dialogue15,tag=!Dialogue16,scores={TalkTime=0}] run tp @e[x=-742,y=90,z=-242,dy=3,nbt=!{cobblemon:npc_trainer}] 289 39 -661

#Kurt NPC
execute at @p[x=371,y=64,z=-698,distance=0..25,tag=Dialogue16,scores={TalkTime=0}] run tp @e[x=-726,y=90,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] 371 64 -698
...
execute as @a[x=343,y=64,z=216,distance=..50,tag=!Dialogue31,scores={TalkTime=0}] run tp @e[x=-758,y=84,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] 343 64 216
...
execute at @a[x=809,y=63,z=14,distance=..50,tag=!Dialogue39] run tp @e[x=-772,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] 809 64 14
...
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-152,y=63,z=212,dy=3,nbt=!{cobblemon:npc_shopkeeper},limit=1] -152 72 212
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-157,y=63,z=193,dy=3,nbt=!{cobblemon:npc_chatting}] -159 72 196
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-157,y=71,z=196,dy=3,nbt=!{cobblemon:npc_shopkeeper},limit=1] -156 64 206
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-155,y=71,z=196,dy=3,nbt=!{cobblemon:npc_chatting}] -149 64 200

#Cleared of Rockets
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-152,y=71,z=212,dy=3,nbt=!{cobblemon:npc_shopkeeper},limit=1] -152 64 212
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-159,y=71,z=196,dy=3,nbt=!{cobblemon:npc_chatting}] -157 64 193
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-156,y=63,z=206,dy=3,nbt=!{cobblemon:npc_shopkeeper},limit=1] -157 72 196
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-149,y=63,z=200,dy=3,nbt=!{cobblemon:npc_chatting}] -155 72 196
...
execute at @a[x=-83,y=45,z=169,distance=..20,tag=!Dialogue54,scores={TalkTime=0}] run tp @e[x=-803,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] -83 45 169

#Dialogue55 - Lance passwords talk
scoreboard players set @a[x=-149,y=34,z=165,distance=..5,tag=!Dialogue55] DialogueTrigger 55
execute at @a[x=-149,y=34,z=165,distance=..25,tag=!Dialogue55,scores={TalkTime=0}] run tp @e[x=-801,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] -149 34 165
...
execute at @a[x=-82,y=34,z=182,distance=..20,tag=!Dialogue59,scores={TalkTime=0}] run tp @e[x=-772,y=88,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] -82 34 182
...
execute at @a[x=-99,y=34,z=205,distance=..20,scores={TalkTime=0},tag=!Dialogue61] run tp @e[x=-799,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_trainer}] -99 34 205
...
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-797,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] -128 45 159
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-795,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] -128 45 171
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-793,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_trainer}] -134 45 170
...
execute unless entity @e[x=-149,y=44,z=177,dx=63,dy=5,dz=35,type=cobblemon:pokemon] as @a[x=-149,y=44,z=177,dx=63,dy=5,dz=35,scores={TalkTime=0},tag=Dialogue63] run scoreboard players set @s[tag=!Dialogue64] DialogueTrigger 64
...
execute at @p[x=426,y=37,z=-304,distance=..25,tag=!Dialogue72] run tp @e[x=-779,y=92,z=-242,dy=3,nbt=!{cobblemon:npc_chatting}] 426 38 -304
execute at @p[x=426,y=37,z=-304,distance=..25,tag=Dialogue72] run tp @e[x=426,y=37,z=-304,dy=3,nbt=!{cobblemon:npc_chatting}] -779 93 -242
...
execute at @a[x=-3060,y=64,z=956,distance=..50,tag=!Dialogue113,tag=Dialogue221] run tp @e[x=-815,y=84,z=-240,dy=3,nbt=!{cobblemon:npc_chatting}] -3060 64 956
...
execute at @a[x=-2697,y=65,z=-39,distance=..20,scores={TalkTime=0},tag=!Dialogue133] run data merge entity @e[x=-2697,y=65,z=-39,distance=..2,nbt=!{cobblemon:statue},limit=1] {ndex:35}
...
execute at @p[x=-2721,y=68,z=374,distance=..20,scores={TalkTime=0},tag=!Dialogue135] run tp @e[x=-2721,y=70,z=374,distance=..1,nbt=!{cobblemon:statue}] -736 75 -242
...
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1}] run execute at @a[x=913,y=63,z=-54,distance=..50] run tp @e[x=-815,y=64,z=-228,dy=3,nbt=!{cobblemon:npc_chatting}] 913 64 -54
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=2}] run execute at @a[x=-482,y=63,z=-535,distance=..50] run tp @e[x=-815,y=64,z=-226,dy=3,nbt=!{cobblemon:npc_chatting}] -482 64 -535
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=3}] run execute at @a[x=-56,y=63,z=722,distance=..50] run tp @e[x=-815,y=64,z=-224,dy=3,nbt=!{cobblemon:npc_chatting}] -56 64 722
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=4}] run execute at @a[x=236,y=64,z=-6,distance=..50] run tp @e[x=-815,y=64,z=-222,dy=3,nbt=!{cobblemon:npc_chatting}] 236 64 -6
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=5}] run execute at @a[x=127,y=63,z=-545,distance=..50] run tp @e[x=-815,y=64,z=-220,dy=3,nbt=!{cobblemon:npc_chatting}] 127 64 -545
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=6}] run execute at @a[x=-663,y=63,z=225,distance=..50] run tp @e[x=-815,y=64,z=-218,dy=3,nbt=!{cobblemon:npc_chatting}] -663 64 225
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=7}] run execute at @a[x=335,y=64,z=113,distance=..50] run tp @e[x=-815,y=64,z=-216,dy=3,nbt=!{cobblemon:npc_chatting}] 335 64 113
...
execute as @a[x=-2748,y=66,z=870,distance=..20,tag=Dialogue217,scores={TalkTime=0},tag=!Dialogue219] run tp @e[x=-815,y=74,z=-233,dy=3,nbt=!{cobblemon:npc_trainer}] -2743 66 870
