...
tag @s add Pryce
give @s pixelmon:glacier_badge 1
tag @s add Clair
give @s pixelmon:rising_badge 1
tag @s add Brock
give @s pixelmon:boulder_badge 1
tag @s add Misty
give @s pixelmon:cascade_badge 1
tag @s add Surge
give @s pixelmon:thunder_badge 1
tag @s add Erika
give @s pixelmon:rainbow_badge 1
tag @s add Janine
give @s pixelmon:soul_badge 1
tag @s add Sabrina
give @s pixelmon:marsh_badge 1
tag @s add Blaine
give @s pixelmon:volcano_badge 1
tag @s add Blue
give @s pixelmon:earth_badge 1
...
give @s pixelmon:hm9
give @s pixelmon:tm_gen4{tm:7}
give @s minecraft:music_disc_far{display:{Name:"Basement Key",Lore:["A key that opens a door in","the Goldenrod Tunnel"]},HideFlags:36}
give @s minecraft:prismarine_crystals{display:{Name:"Rainbow Wing",Lore:["A strange, rainbow feather","that sparkles."]},ench:[{id:"2",lvl:"1"}],HideFlags:1}
give @s pixelmon:tm_gen4{tm:59}
give @s pixelmon:master_ball
give @s minecraft:music_disc_chirp{display:{Name:"S.S. Ticket",Lore:["The ticket required for sailing on","the ferry S.S. Aqua in Olivine and","Vermilion City. It has a drawing","of a ship in it."]},HideFlags:36}
give @s pixelmon:tm_gen4{tm:3}
give @s pixelmon:tm_gen4{tm:34}
give @s pixelmon:tm_gen2{tm:19}
give @s pixelmon:tm_gen4{tm:84}
give @s pixelmon:tm_gen4{tm:48}
give @s pixelmon:tm_gen4{tm:50}
give @s pixelmon:tm_gen4{tm:92}
give @s pixelmon:tm_gen4{tm:57}
...
#Advancements
advancement grant @s only johto:root
advancement grant @s only johto:badge1
advancement grant @s only johto:rocket1
advancement grant @s only johto:badge2
advancement grant @s only johto:badge3
advancement grant @s only johto:badge4
advancement grant @s only johto:badge5
advancement grant @s only johto:badge6
advancement grant @s only johto:rocket3
advancement grant @s only johto:badge7
advancement grant @s only johto:rocket4
advancement grant @s only johto:champion
advancement grant @s only johto:event9
advancement grant @s only johto:event7
